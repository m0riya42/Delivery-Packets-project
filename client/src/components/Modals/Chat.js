...
const Chat = ({  }) => {
    ...
    return (
        <modal className="popup-box" style={{ background: "transparent" }}>
   
                    <div className="col-lg-5" style={{ bottom: "10%",  position: "absolute"}}>
                        <div className="box box-primary direct-chat direct-chat-primary" style={{marginTop: "50px"}}>
